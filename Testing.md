...
- Validación rechaza valores inválidos (422)
...
- `onChange` se llama con el valor correcto al cambiar `category_id`, `condition`, `min_price` y `max_price`
...
- "Limpiar todo" resetea los cuatro campos a vacío
...
- Cambiar categoría o condition provoca una nueva llamada con los query params correctos
